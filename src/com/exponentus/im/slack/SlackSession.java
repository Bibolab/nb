...
import com.exponentus.im.slack.listeners.SlackDisconnectedListener;
import com.exponentus.im.slack.replies.EmojiSlackReply;
...
public interface SlackSession {
	...
	/*
	 * Subscribe to events related to the actions to the slack server. At this
	 * time a set of status information is exchanged that is useful to
	 * implementing bots.
	 * 
	 * For example, the current user that is connecting. knowing your own user
	 * id will help you stop answering your own questions.
	 */
