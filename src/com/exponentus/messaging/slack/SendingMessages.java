...
public class SendingMessages {
	...
	/**
	 * This method shows how to send a message to a given channel (public
	 * channel, private group or direct message channel)
	 */
	...
	/**
	 * This method shows how to send a direct message to a user, but this time
	 * it shows how it can be done using the direct message channels
	 */
	...
	public void sendDirectMessageToMultipleUsers(SlackSession session) {
		...
		// open a multiparty direct message channel between the bot and these
		// users
	...
	public void sendUsingPreparedMessage(SlackSession session) {
		...
		SlackPreparedMessage preparedMessage = new SlackPreparedMessage.Builder().withMessage("Hey, this is a message").withUnfurl(false)
