    ...
    <xsl:template name="_content">
        <div class="content-header">
            <xsl:call-template name="page-info">
                 <xsl:with-param name="title" select="'Rule files'"/>
            </xsl:call-template>
        </div>
            ...
            <div data-id="{@id}" class="entry">
                ...
                <a href="{@url}" class="entry-link">
                    <div class="entry-fields">
                        <span class="vw-balance-holder">
                            <xsl:value-of select="viewcontent/ison"/>
                        </span>
                        <span class="vw-tags">
                            <xsl:value-of select="viewcontent/id"/>
                        </span>
                        <span class="vw-regdate">
                            <xsl:value-of select="viewcontent/issecured"/>
                        </span>
                        <span class="vw-regdate">
                            <xsl:value-of select="viewcontent/caching"/>
                        </span>
                    </div>
                </a>
            </div>
